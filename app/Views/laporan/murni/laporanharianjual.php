                ...
                <div class="col-sm-5">
                    <div class="form-group row">
                        ...
                        <div class="col-9 input-group">
                            ...
                            <select hidden name="kadar" id="tgl" class="form-control col-sm-3">
                                <option value="">Kadar %</option>
                                <option value="">Hancuran</option>
                                <option value="">75 %</option>
                                <option value="">76-99 %</option>
                            </select>
...
function lihattabellaporan() {
    ...
    if (tgl == "") {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('laporan/tabeljualharianmurni') ?>",
            data: {
                tgl: tgl,
            },
            dataType: "JSON",
...
function PrintLaporan() {
    ...
    if (tgl == "") {
        ...
        NewWin = window.open('<?= base_url('Laporan/PrintLaporanHarianJualMurni') ?>/' + tgl, 'NewWin',
